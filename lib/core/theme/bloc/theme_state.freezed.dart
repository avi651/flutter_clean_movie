...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ThemeState&&(identical(other.selectedThemeMode, selectedThemeMode) || other.selectedThemeMode == selectedThemeMode));
}
...
/// Create a copy of ThemeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? selectedThemeMode = null,}) {
  return _then(_self.copyWith(
selectedThemeMode: null == selectedThemeMode ? _self.selectedThemeMode : selectedThemeMode // ignore: cast_nullable_to_non_nullable
as ThemeMode,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode selectedThemeMode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ThemeState() when $default != null:
return $default(_that.selectedThemeMode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode selectedThemeMode)  $default,) {final _that = this;
switch (_that) {
case _ThemeState():
return $default(_that.selectedThemeMode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode selectedThemeMode)?  $default,) {final _that = this;
switch (_that) {
case _ThemeState() when $default != null:
return $default(_that.selectedThemeMode);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ThemeState&&(identical(other.selectedThemeMode, selectedThemeMode) || other.selectedThemeMode == selectedThemeMode));
}
...
/// Create a copy of ThemeState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? selectedThemeMode = null,}) {
