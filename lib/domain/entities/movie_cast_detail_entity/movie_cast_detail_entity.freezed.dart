...
part of 'movie_cast_detail_entity.dart';
...
/// Create a copy of MovieCastDetailEntity
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MovieCastDetailEntityCopyWith<MovieCastDetailEntity> get copyWith => _$MovieCastDetailEntityCopyWithImpl<MovieCastDetailEntity>(this as MovieCastDetailEntity, _$identity);

  /// Serializes this MovieCastDetailEntity to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MovieCastDetailEntity&&(identical(other.adult, adult) || other.adult == adult)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.id, id) || other.id == id)&&(identical(other.knownForDepartment, knownForDepartment) || other.knownForDepartment == knownForDepartment)&&(identical(other.name, name) || other.name == name)&&(identical(other.originalName, originalName) || other.originalName == originalName)&&(identical(other.popularity, popularity) || other.popularity == popularity)&&(identical(other.profilePath, profilePath) || other.profilePath == profilePath)&&(identical(other.castId, castId) || other.castId == castId)&&(identical(other.character, character) || other.character == character)&&(identical(other.creditId, creditId) || other.creditId == creditId)&&(identical(other.order, order) || other.order == order));
}
...
@override
String toString() {
  return 'MovieCastDetailEntity(adult: $adult, gender: $gender, id: $id, knownForDepartment: $knownForDepartment, name: $name, originalName: $originalName, popularity: $popularity, profilePath: $profilePath, castId: $castId, character: $character, creditId: $creditId, order: $order)';
}
...
/// @nodoc
abstract mixin class $MovieCastDetailEntityCopyWith<$Res>  {
  factory $MovieCastDetailEntityCopyWith(MovieCastDetailEntity value, $Res Function(MovieCastDetailEntity) _then) = _$MovieCastDetailEntityCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$MovieCastDetailEntityCopyWithImpl<$Res>
    implements $MovieCastDetailEntityCopyWith<$Res> {
  _$MovieCastDetailEntityCopyWithImpl(this._self, this._then);

  final MovieCastDetailEntity _self;
  final $Res Function(MovieCastDetailEntity) _then;

/// Create a copy of MovieCastDetailEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? adult = null,Object? gender = null,Object? id = null,Object? knownForDepartment = freezed,Object? name = null,Object? originalName = null,Object? popularity = null,Object? profilePath = freezed,Object? castId = freezed,Object? character = null,Object? creditId = freezed,Object? order = null,}) {
...
/// Adds pattern-matching-related methods to [MovieCastDetailEntity].
extension MovieCastDetailEntityPatterns on MovieCastDetailEntity {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MovieCastDetailEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MovieCastDetailEntity() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MovieCastDetailEntity value)  $default,){
final _that = this;
switch (_that) {
case _MovieCastDetailEntity():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MovieCastDetailEntity value)?  $default,){
final _that = this;
switch (_that) {
case _MovieCastDetailEntity() when $default != null:
return $default(_that);case _:
...
class _MovieCastDetailEntity extends MovieCastDetailEntity {
  const _MovieCastDetailEntity({required this.adult, required this.gender, required this.id, @JsonKey(name: 'known_for_department') this.knownForDepartment, required this.name, @JsonKey(name: 'original_name') required this.originalName, required this.popularity, @JsonKey(name: 'profile_path') this.profilePath, @JsonKey(name: 'cast_id') this.castId, required this.character, @JsonKey(name: 'credit_id') required this.creditId, required this.order}): super._();
  factory _MovieCastDetailEntity.fromJson(Map<String, dynamic> json) => _$MovieCastDetailEntityFromJson(json);
...
@pragma('vm:prefer-inline')
_$MovieCastDetailEntityCopyWith<_MovieCastDetailEntity> get copyWith => __$MovieCastDetailEntityCopyWithImpl<_MovieCastDetailEntity>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$MovieCastDetailEntityToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MovieCastDetailEntity&&(identical(other.adult, adult) || other.adult == adult)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.id, id) || other.id == id)&&(identical(other.knownForDepartment, knownForDepartment) || other.knownForDepartment == knownForDepartment)&&(identical(other.name, name) || other.name == name)&&(identical(other.originalName, originalName) || other.originalName == originalName)&&(identical(other.popularity, popularity) || other.popularity == popularity)&&(identical(other.profilePath, profilePath) || other.profilePath == profilePath)&&(identical(other.castId, castId) || other.castId == castId)&&(identical(other.character, character) || other.character == character)&&(identical(other.creditId, creditId) || other.creditId == creditId)&&(identical(other.order, order) || other.order == order));
}
...
/// @nodoc
abstract mixin class _$MovieCastDetailEntityCopyWith<$Res> implements $MovieCastDetailEntityCopyWith<$Res> {
  factory _$MovieCastDetailEntityCopyWith(_MovieCastDetailEntity value, $Res Function(_MovieCastDetailEntity) _then) = __$MovieCastDetailEntityCopyWithImpl;
@override @useResult
$Res call({
 bool adult, int gender, int id,@JsonKey(name: 'known_for_department') String? knownForDepartment, String name,@JsonKey(name: 'original_name') String originalName, double popularity,@JsonKey(name: 'profile_path') String? profilePath,@JsonKey(name: 'cast_id') int? castId, String character,@JsonKey(name: 'credit_id') String? creditId, int order
});
...
/// @nodoc
class __$MovieCastDetailEntityCopyWithImpl<$Res>
    implements _$MovieCastDetailEntityCopyWith<$Res> {
  __$MovieCastDetailEntityCopyWithImpl(this._self, this._then);

  final _MovieCastDetailEntity _self;
  final $Res Function(_MovieCastDetailEntity) _then;

/// Create a copy of MovieCastDetailEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? adult = null,Object? gender = null,Object? id = null,Object? knownForDepartment = freezed,Object? name = null,Object? originalName = null,Object? popularity = null,Object? profilePath = freezed,Object? castId = freezed,Object? character = null,Object? creditId = freezed,Object? order = null,}) {
  return _then(_MovieCastDetailEntity(
adult: null == adult ? _self.adult : adult // ignore: cast_nullable_to_non_nullable
as bool,gender: null == gender ? _self.gender : gender // ignore: cast_nullable_to_non_nullable
as int,id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,knownForDepartment: freezed == knownForDepartment ? _self.knownForDepartment : knownForDepartment // ignore: cast_nullable_to_non_nullable
