...
part of 'movie_result_entity.dart';
...
/// Create a copy of MovieResultEntity
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MovieResultEntityCopyWith<MovieResultEntity> get copyWith => _$MovieResultEntityCopyWithImpl<MovieResultEntity>(this as MovieResultEntity, _$identity);

  /// Serializes this MovieResultEntity to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MovieResultEntity&&(identical(other.adult, adult) || other.adult == adult)&&(identical(other.backdropPath, backdropPath) || other.backdropPath == backdropPath)&&const DeepCollectionEquality().equals(other.genreIds, genreIds)&&(identical(other.id, id) || other.id == id)&&(identical(other.originalLanguage, originalLanguage) || other.originalLanguage == originalLanguage)&&(identical(other.originalTitle, originalTitle) || other.originalTitle == originalTitle)&&(identical(other.overview, overview) || other.overview == overview)&&(identical(other.popularity, popularity) || other.popularity == popularity)&&(identical(other.posterPath, posterPath) || other.posterPath == posterPath)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&(identical(other.title, title) || other.title == title)&&(identical(other.video, video) || other.video == video)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.voteCount, voteCount) || other.voteCount == voteCount));
}
...
/// @nodoc
abstract mixin class $MovieResultEntityCopyWith<$Res>  {
  factory $MovieResultEntityCopyWith(MovieResultEntity value, $Res Function(MovieResultEntity) _then) = _$MovieResultEntityCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$MovieResultEntityCopyWithImpl<$Res>
    implements $MovieResultEntityCopyWith<$Res> {
  _$MovieResultEntityCopyWithImpl(this._self, this._then);

  final MovieResultEntity _self;
  final $Res Function(MovieResultEntity) _then;
...
/// Adds pattern-matching-related methods to [MovieResultEntity].
extension MovieResultEntityPatterns on MovieResultEntity {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MovieResultEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MovieResultEntity() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MovieResultEntity value)  $default,){
final _that = this;
switch (_that) {
case _MovieResultEntity():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MovieResultEntity value)?  $default,){
final _that = this;
switch (_that) {
case _MovieResultEntity() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$MovieResultEntityCopyWith<_MovieResultEntity> get copyWith => __$MovieResultEntityCopyWithImpl<_MovieResultEntity>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$MovieResultEntityToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MovieResultEntity&&(identical(other.adult, adult) || other.adult == adult)&&(identical(other.backdropPath, backdropPath) || other.backdropPath == backdropPath)&&const DeepCollectionEquality().equals(other._genreIds, _genreIds)&&(identical(other.id, id) || other.id == id)&&(identical(other.originalLanguage, originalLanguage) || other.originalLanguage == originalLanguage)&&(identical(other.originalTitle, originalTitle) || other.originalTitle == originalTitle)&&(identical(other.overview, overview) || other.overview == overview)&&(identical(other.popularity, popularity) || other.popularity == popularity)&&(identical(other.posterPath, posterPath) || other.posterPath == posterPath)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&(identical(other.title, title) || other.title == title)&&(identical(other.video, video) || other.video == video)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.voteCount, voteCount) || other.voteCount == voteCount));
}
...
/// @nodoc
abstract mixin class _$MovieResultEntityCopyWith<$Res> implements $MovieResultEntityCopyWith<$Res> {
  factory _$MovieResultEntityCopyWith(_MovieResultEntity value, $Res Function(_MovieResultEntity) _then) = __$MovieResultEntityCopyWithImpl;
@override @useResult
$Res call({
 bool adult,@JsonKey(name: 'backdrop_path') String? backdropPath,@JsonKey(name: 'genre_ids') List<int> genreIds, int id,@JsonKey(name: 'original_language') String originalLanguage,@JsonKey(name: 'original_title') String originalTitle, String overview, double popularity,@JsonKey(name: 'poster_path') String? posterPath,@JsonKey(name: 'release_date') String releaseDate, String title, bool video,@JsonKey(name: 'vote_average') double voteAverage,@JsonKey(name: 'vote_count') int voteCount
});
...
/// @nodoc
class __$MovieResultEntityCopyWithImpl<$Res>
    implements _$MovieResultEntityCopyWith<$Res> {
  __$MovieResultEntityCopyWithImpl(this._self, this._then);

  final _MovieResultEntity _self;
  final $Res Function(_MovieResultEntity) _then;

/// Create a copy of MovieResultEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? adult = null,Object? backdropPath = freezed,Object? genreIds = null,Object? id = null,Object? originalLanguage = null,Object? originalTitle = null,Object? overview = null,Object? popularity = null,Object? posterPath = freezed,Object? releaseDate = null,Object? title = null,Object? video = null,Object? voteAverage = null,Object? voteCount = null,}) {
  return _then(_MovieResultEntity(
adult: null == adult ? _self.adult : adult // ignore: cast_nullable_to_non_nullable
as bool,backdropPath: freezed == backdropPath ? _self.backdropPath : backdropPath // ignore: cast_nullable_to_non_nullable
