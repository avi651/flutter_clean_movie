...
part of 'movie_similar_detail_entity.dart';
...
/// @nodoc
mixin _$MovieSimilarDetailEntity {
...
/// Create a copy of MovieSimilarDetailEntity
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MovieSimilarDetailEntityCopyWith<MovieSimilarDetailEntity> get copyWith => _$MovieSimilarDetailEntityCopyWithImpl<MovieSimilarDetailEntity>(this as MovieSimilarDetailEntity, _$identity);

  /// Serializes this MovieSimilarDetailEntity to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MovieSimilarDetailEntity&&(identical(other.adult, adult) || other.adult == adult)&&(identical(other.backdropPath, backdropPath) || other.backdropPath == backdropPath)&&const DeepCollectionEquality().equals(other.genreIds, genreIds)&&(identical(other.id, id) || other.id == id)&&(identical(other.originalLanguage, originalLanguage) || other.originalLanguage == originalLanguage)&&(identical(other.originalTitle, originalTitle) || other.originalTitle == originalTitle)&&(identical(other.overview, overview) || other.overview == overview)&&(identical(other.popularity, popularity) || other.popularity == popularity)&&(identical(other.posterPath, posterPath) || other.posterPath == posterPath)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&(identical(other.title, title) || other.title == title)&&(identical(other.video, video) || other.video == video)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.voteCount, voteCount) || other.voteCount == voteCount));
}
...
/// @nodoc
abstract mixin class $MovieSimilarDetailEntityCopyWith<$Res>  {
  factory $MovieSimilarDetailEntityCopyWith(MovieSimilarDetailEntity value, $Res Function(MovieSimilarDetailEntity) _then) = _$MovieSimilarDetailEntityCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$MovieSimilarDetailEntityCopyWithImpl<$Res>
    implements $MovieSimilarDetailEntityCopyWith<$Res> {
  _$MovieSimilarDetailEntityCopyWithImpl(this._self, this._then);

  final MovieSimilarDetailEntity _self;
  final $Res Function(MovieSimilarDetailEntity) _then;
...
/// Adds pattern-matching-related methods to [MovieSimilarDetailEntity].
extension MovieSimilarDetailEntityPatterns on MovieSimilarDetailEntity {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MovieSimilarDetailEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MovieSimilarDetailEntity() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MovieSimilarDetailEntity value)  $default,){
final _that = this;
switch (_that) {
case _MovieSimilarDetailEntity():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MovieSimilarDetailEntity value)?  $default,){
final _that = this;
switch (_that) {
case _MovieSimilarDetailEntity() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$MovieSimilarDetailEntityCopyWith<_MovieSimilarDetailEntity> get copyWith => __$MovieSimilarDetailEntityCopyWithImpl<_MovieSimilarDetailEntity>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$MovieSimilarDetailEntityToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MovieSimilarDetailEntity&&(identical(other.adult, adult) || other.adult == adult)&&(identical(other.backdropPath, backdropPath) || other.backdropPath == backdropPath)&&const DeepCollectionEquality().equals(other._genreIds, _genreIds)&&(identical(other.id, id) || other.id == id)&&(identical(other.originalLanguage, originalLanguage) || other.originalLanguage == originalLanguage)&&(identical(other.originalTitle, originalTitle) || other.originalTitle == originalTitle)&&(identical(other.overview, overview) || other.overview == overview)&&(identical(other.popularity, popularity) || other.popularity == popularity)&&(identical(other.posterPath, posterPath) || other.posterPath == posterPath)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&(identical(other.title, title) || other.title == title)&&(identical(other.video, video) || other.video == video)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.voteCount, voteCount) || other.voteCount == voteCount));
}
...
/// @nodoc
abstract mixin class _$MovieSimilarDetailEntityCopyWith<$Res> implements $MovieSimilarDetailEntityCopyWith<$Res> {
  factory _$MovieSimilarDetailEntityCopyWith(_MovieSimilarDetailEntity value, $Res Function(_MovieSimilarDetailEntity) _then) = __$MovieSimilarDetailEntityCopyWithImpl;
@override @useResult
$Res call({
 bool adult,@JsonKey(name: 'backdrop_path') String? backdropPath,@JsonKey(name: 'genre_ids') List<int> genreIds, int id,@JsonKey(name: 'original_language') String originalLanguage,@JsonKey(name: 'original_title') String originalTitle, String overview, double popularity,@JsonKey(name: 'poster_path') String? posterPath,@JsonKey(name: 'release_date') String releaseDate, String title, bool video,@JsonKey(name: 'vote_average') double voteAverage,@JsonKey(name: 'vote_count') int voteCount
});
...
/// @nodoc
class __$MovieSimilarDetailEntityCopyWithImpl<$Res>
    implements _$MovieSimilarDetailEntityCopyWith<$Res> {
  __$MovieSimilarDetailEntityCopyWithImpl(this._self, this._then);

  final _MovieSimilarDetailEntity _self;
  final $Res Function(_MovieSimilarDetailEntity) _then;

/// Create a copy of MovieSimilarDetailEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? adult = null,Object? backdropPath = freezed,Object? genreIds = null,Object? id = null,Object? originalLanguage = null,Object? originalTitle = null,Object? overview = null,Object? popularity = null,Object? posterPath = freezed,Object? releaseDate = null,Object? title = null,Object? video = null,Object? voteAverage = null,Object? voteCount = null,}) {
  return _then(_MovieSimilarDetailEntity(
adult: null == adult ? _self.adult : adult // ignore: cast_nullable_to_non_nullable
as bool,backdropPath: freezed == backdropPath ? _self.backdropPath : backdropPath // ignore: cast_nullable_to_non_nullable
